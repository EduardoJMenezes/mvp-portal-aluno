 ...
 */
@SpringBootTest(properties = "plataforma.token-de-servico=" + BaseDeComando.TOKEN)
...
public abstract class BaseDeComando {
    ...
    @BeforeEach
    void cenario() {
        jdbc.execute("TRUNCATE users, classes, videos, subjects, questions, exams, drafts, imports, images RESTART IDENTITY CASCADE");
        jdbc.update("""
