...
def test_claude_code_monta_o_simulado_e_anexa_a_figura_mas_nao_publica(db, mundo, api_java):
...
def test_prints_chegam_pela_pagina_de_envio_e_o_professor_ve_pela_api(db, mundo, api_java):
